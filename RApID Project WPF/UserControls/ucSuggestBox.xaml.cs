...
namespace RApID_Project_WPF.UserControls
{
    ...
    public partial class ucSuggestBox : UserControl
    {
        ...
        public static readonly DependencyProperty _text = DependencyProperty.Register("Text", typeof(string), typeof(ucSuggestBox), new PropertyMetadata(""));
        public static readonly DependencyProperty _isReadOnly = DependencyProperty.Register("IsReadOnly", typeof(bool), typeof(ucSuggestBox), new PropertyMetadata(false));
        public static readonly DependencyProperty _lblContent = DependencyProperty.Register("LabelContent", typeof(string), typeof(Label), new PropertyMetadata("Suggest Label:"));
        ...
        {
            get => (string)GetValue(_lblContent);
            set
            {
                SetValue(_lblContent, value);
            }
        }
